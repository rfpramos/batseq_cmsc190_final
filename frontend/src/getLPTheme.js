...
const getDesignTokens = (mode) => ({
  palette: {
    ...
    background: {
      default: '#fff',
      paper: gray[50],
      image: 'url("/background.png")', // Correct path for the background image
      overlay: 'rgba(0, 0, 0, 0.5)', // Add this line for the overlay color
      ...(mode === 'dark' && { 
        default: gray[900], 
        paper: gray[800],
        image: 'url("/background.png")', // Correct path for the background image in dark mode
        overlay: 'rgba(0, 0, 0, 0.7)', // Overlay color for dark mode
      }),
    },
    text: {
      primary: gray[800],
